...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  bubbleInner.style.width = '214px';
  bubbleInner.style.margin = isIpad ? '0 0 0 82px' : '0 auto';
  bubbleInner.style.border = 'solid 3px #4479ae';
  bubbleInner.style.padding = '20px 20px 20px 10px';
  bubbleInner.style.WebkitBorderRadius = '4px';
  bubbleInner.style.WebkitBoxShadow = '0 0 4px rgba(0, 0, 0, 0.7)';
  bubbleInner.style.WebkitBackgroundSize = '100% 4px';
  // bubbleInner.style.backgroundColor = '#b0c8ec';
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    // bubbleInner.innerHTML = 'Install this web app on your phone: ' +
		...
		bubbleInner.innerHTML = '矢印をタップして<b>「ホーム画面に追加」</b>してください。';
  } else {
    // bubbleInner.innerHTML = 'Install this web app on your phone: ' +
    //     'tap <b style="font-size:15px">+</b> and then ' +
    //     '<b>\'Add to Home Screen\'</b>';
    bubbleInner.innerHTML = '<b>+</b>をタップして<b>「ホーム画面に追加」</b>してください。';
  }
  ...
  //change
	...
	arrow.style.border = 'solid 3px #4479ae';
